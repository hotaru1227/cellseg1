...
if __name__ == "__main__":
    ...
    select_train_num_for_train_configs = ["full"]
    select_train_num_for_test_configs = ["1", "5"]
    ...
    df.to_csv(PROJECT_ROOT / f"experiment_in_paper/result/result_CPG_generalization_{time_str}.csv", index=False)
